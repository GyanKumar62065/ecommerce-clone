    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10  pt-10">
          ...
          {/* Product info */}
          <div className="lg:col-span-1 max-auto max-w-2xl  pb-16  lg:max-w-7xl  lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className=" flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">3487 Ratings</p>
        ...
        <section className="pb-10">
          <h1 className="font-semibold text-lg pb-4">Recent Reviw & Rating</h1>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60 ">4762 Ratings</p>
                </div>
